...
/**
 * Переделать этот Класс, для пользователей, которые будут проходить дополнительную регистрацию в качестве исполнителя
 */

@Data
@FieldMatch(first = "password", second = "matchingPassword", message = "The password fields must match")
public class SystemUserOld {
